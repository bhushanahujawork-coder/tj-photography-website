...
function FilmCard({
  ...
  return (
    ...
    >
      ...
      <span className="absolute -right-2 -bottom-2 w-12 h-12 md:-right-3 md:w-[64px] md:h-[64px] rounded-full bg-[#faf8f4] shadow-lg flex items-center justify-center">
        <svg
          className="w-5 h-5 md:w-6 md:h-6 text-[#1f2428]"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth={2.3}
