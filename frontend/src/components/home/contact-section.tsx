...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative w-full bg-[#eae1d2] py-16 md:py-20 2xl:py-28 scroll-mt-20 md:scroll-mt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-stretch">
          <div className="relative w-full min-h-[300px] md:min-h-[420px] 2xl:min-h-[500px] rounded-xl overflow-hidden border border-gold/25 shadow-lg shadow-black/10">
            ...
            <a
              ...
              className="absolute bottom-3 left-3 z-10 inline-flex items-center gap-2 bg-black/75 backdrop-blur-md text-white text-[11px] tracking-[0.15em] uppercase px-5 py-2.5 rounded-full border border-gold/40 hover:bg-black transition-colors duration-300"
            >
